...
export default function HeroPublic() {
  ...
  const handleCheck = () => {
    if (!q.trim()) {
      alert("Masukkan nomor sertifikat atau kode verifikasi")
      return
    }
  ...
  return (
    <section className="bg-gradient-to-b from-[#0A0A0A] to-[#111111] text-center flex flex-col items-center justify-center py-32 px-6">
      ...
      <p className="mt-3 text-[#AAAAAA] max-w-2xl">Masukkan nomor sertifikat atau kode verifikasi untuk memeriksa keasliannya.</p>
